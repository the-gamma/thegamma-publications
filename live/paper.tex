...
used in Figure~\ref{fig:thegamma} as asynchronous [X]. It downloads the sample URL and generates 
...
Type providers can also be implemented as REST services [X] to allow anyone implement a data source
...
type checking of lambda functions in C\# [X], where type is also inferred from the context (or has
