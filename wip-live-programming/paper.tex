...
\authorinfo{Tomas is xxx. Contact him at \email{tomas@tomasp.net}.}
\affiliation[a]{University of Kent, UK}
\keywords{xxx}
\paperdetails{
  perspective=engineering,
  area={History and philosophy of programming},
}
...
Rewrite according to guidelines.
...
\begin{figure}
  ...
  \centering
  \subcaptionbox{
    \raggedright\footnotesize The analysis counts the number of distinct events per
      athlete. After typing `.' the editor offers further aggregation operations.
    \label{fig:gamma-dot}
  }{\includegraphics[scale=0.26]{figures/gamma1.png}}
  \subcaptionbox{
    \raggedright\footnotesize
      Our live coding environment for The Gamma. The table is updated on-the-fly a
      and shows the result at the current cursor position.
    \label{fig:gamma-preview}
  }{\includegraphics[scale=0.26]{figures/gamma2.png}}
