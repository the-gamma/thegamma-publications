...
\subcaptionbox{
  \raggedright\footnotesize
    Our live programming environment for The Gamma. The table is updated on-the-fly a
    and shows the result at the current cursor position.
  \label{fig:gamma-preview}
}{\includegraphics[scale=0.26]{figures/gamma2.png}}
\vspace{0.5em}
\caption{\small Previous work on The Gamma with auto-complete based on type information (left)
