...
\authorinfo{
\noindent
Tomas is a lecturer at University of Kent. He is working on making programming and data science
easier and more accessible. His research interests span a range of areas including theory of
programming languages, history and philosophy of programming, as well as open data and data
journalism.
%
...
\keywords{Data exploration, live coding, data journalism, instant previews}
\paperdetails{
...
{\scriptsize
~\\
\textbf{Note to reviewers:} This paper has been previously submitted to a different
venue. The revisions made in response to past reviews are summarized in Appendix~\ref{sec:revisions}
