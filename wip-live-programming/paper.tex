...
\item The left screenshot uses a type provider for data aggregation introduced by \citet{gamma}
  and briefly discussed in Section~\ref{sec:background-gamma}. For the purpose of
...
\item The live preview for code written using the data aggregation type provider (left) is shown
...
human-computer interaction perspective is left for future work. To give anecdotal evidence of
