...
allow a more high-level specification of certain charts. Finally, there are also some obvious
ways in which a type system could prevent errors, for example by checking that categorical and
continuous values are not mixed on a single scale.
