...
\begin{figure}
  \begin{subfigure}[b]{0.49\textwidth}
    ...
    \begin{tabular}{l l l c l}
      ...
      \bottomrule
    \end{tabular}
    \caption{Work completed by individual participants. The marks denote:
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    ...
    \begin{tabular}{p{17.25em} c c}
      ...
      \small \quad I found the system easy to use. & \small 3.89 & \small 0.87\\
      \small \quad Journalists will be able to use it to analyse data. & \small 3.33 & \small 1.05\\
      \small \quad Readers will be able to examine the analyses. & \small 3.56 & \small 0.68\\
      \small Thinking about the usability of the system:\\
      \small \quad Resulting programs are easy to understand. & \small 3.67 & \small 0.82\\
      \small \quad Text editor for creating them was easy to use. & \small 3.67 & \small 0.94\\
      \small \quad Finding items in the auto-complete was easy. & \small 3.44 & \small 1.42\\
      \small I would know how to explore a new data source\\
      \small \quad If given a comprehensive video tutorial. & \small 4.00 & \small 1.24\\
      \small \quad If given a number of code samples. & \small 3.22 & \small 1.13\\
      \small \quad Without any further guidance. & \small 2.44 & \small 1.17 \vspace{0.1em}\\
      \bottomrule
    \end{tabular}
    \caption{Follow-up questionnaire responses using
      a 5-point Likert scale (1 = strongly disagree, 5 = strongly agree) over 9 subjects.}
    \label{tab:quest}
  \end{subfigure}
  \caption{Summary of the work completed by individual participants and responses in a follow-up questionnaire}
  \label{tab:tabs}
\end{figure}
