...
kind. Technically, it generates object types with members (such as \ikvd{sort by} or \ikvd{Count is})
...
Bank\footnote{The data is retrieved using an API available at: \url{https://data.worldbank.org/}}
