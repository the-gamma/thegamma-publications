...
$v=\vect{\{f_1\mapsto v_{1,1}, \ldots, f_n\mapsto v_{1,n}\},\ldots,\{f_1\mapsto v_{m,1}, \ldots, f_n\mapsto v_{m,n}\}}$
...
\tau_{f_{p(1)}, \ldots, f_{p(m)}} \{f_1\mapsto \vect{v_{1,1},\ldots,v_{1,r}}, \ldots, f_n\mapsto \vect{v_{n,1},\ldots,v_{n,r}}\} \leadsto\\
  ...
  \\
  \\
\Phi_{f_i, \rho_1, \ldots, \rho_m} \{f_1\mapsto \vect{v_{1,1},\ldots,v_{1,r}}, \ldots, f_n\mapsto \vect{v_{n,1},\ldots,v_{n,r}}\} \leadsto\\
  \quad \{\ident{nm}(\rho_1)\mapsto a_1, \ldots, \ident{nm}(\rho_m)\mapsto a_m \} 
...
%\noindent
\begin{equation*}
\Pi_{f_{p(1)}, \ldots, f_{p(n)}} \{f_1\mapsto \overline{v_1}, \ldots, f_n\mapsto \overline{v_m}\}
  \leadsto \{f_{p(1)}\mapsto \overline{v_{p(1)}}, \ldots, f_{p(n)}\mapsto \overline{v_{p(n)}}\}
\end{equation*}
